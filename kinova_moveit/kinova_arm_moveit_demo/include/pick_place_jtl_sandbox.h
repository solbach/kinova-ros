#ifndef PICK_PLACE_JTL_SANDBOX_H
#define PICK_PLACE_JTL_SANDBOX_H
...
namespace kinova
{
    ...
    class PickPlaceJTLSandbox
    {
    public:
        PickPlaceJTLSandbox(ros::NodeHandle &nh);
        ~PickPlaceJTLSandbox();
...
//        robot_state::RobotStatePtr robot_state_;
        ...
        // define pick_place_jtl joint value and pose
...
#endif // PICK_PLACE_JTL_SANDBOX_H
